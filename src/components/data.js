export default  {
    ...
    {
        title : "Consignes",
        link : "/docs/manuel-caisse/caisse/consignes",
        description : "Encaisser un paiement de consigne lors d’un prêt d’un produit associé à une vente (cocotte, plateau, etc.)",
    ...
    },
    {
        ...
        link : "/docs/manuel-caisse/caisse/controle-espece",
        description : "Effectuer un comptage tiroir en cours de journée pour contrôler le solde.",
    ...
    },
    {
        ...
        link : "/docs/manuel-caisse/caisse/controle-tiroir",
        description : "Effectuer un contrôle de votre tiroir en cours de journée, afin de vérifier votre tiroir sur les règlements autres que les espèces.",
    ...
    {
        title : "Devis client",
        link : "/docs/manuel-caisse/caisse/devis-client",
        description : "Effectuer un devis de prix à un client depuis la caisse.",
    ...
    },
    {
        ...
        link : "/docs/manuel-caisse/caisse/mise-en-attente-vente",
        description : "Mettre une vente en attente.",
    ...
    {
        title : "Prélèvement",
        link : "/docs/manuel-caisse/caisse/prelevement",
        description : "Prélever des espèces en cours de journée afin de soulager le tiroir.",
    ...
    },
    {
        ...
        theme :"Reglement client reglement client règlement client réglement client Les clients dont les **paiements sont différés « En compte »** et qui règlent à posteriori Le règlement d’un client vient **se soustraire de son solde**. Après avoir sélectionné le client, saisissez **le montant réglé par le Client et le moyen de paiement utilisé**. Validez. La fenêtre de sélection du client s’affiche (cf. [Lien vers tutorial recherche et création client](https://aide.seg2inov.eu/docs/manuel-caisse/client/recherche))."
    },
    {
        title : "Remise sur total",
        link : "/docs/manuel-caisse/caisse/remise-sur-total",
        description : "Effectuer une remise en pourcentage sur la totalité de la vente.",
    ...
    {
        title : "Fiche client",
        link : "/docs/manuel-caisse/client/fiche-client",
        description : "Comprendre la fiche client.",
    ...
    },
    {
        ...
        link : "/docs/manuel-caisse/client/historique-client",
        description : "Visualiser l'historique d'un client associé à une vente.",
        theme :"CLIENT Client cilent HISTORIQUE CLIENT Historique historique client"
    },
    {
        title : "Recherche client",
        link : "/docs/manuel-caisse/client/recherche",
        description : "Associer un client à votre vente.",
    ...
    },
    {
        ...
        link : "/docs/manuel-caisse/caisse/recette-caisse",
        description : "Enregistrer une entrée d’espèces en dehors d’une vente. ",
    ...
    },
    {
        ...
        link : "/docs/manuel-caisse/produit/retour-produit",
        description : "Effectuer un retour produit.",
        theme :"retour produit Retour produit RETOUR PRODUIT retour d'un produit retourner un produit."
    },
    {
        title : "Sélectionner un produit pour réaliser des actions",
        link : "/docs/manuel-caisse/produit/actions/selectionner-un-produit",
    ...
    },
    {
        ...
        link : "/docs/manuel-caisse/produit/actions/promotion",
        description : "Consulter les promotions sur les produits.",
    ...
    {
        title : "Tare",
        link : "/docs/manuel-caisse/produit/Poids/tare",
    ...
    },
    {
        ...
        link : "/docs/manuel-gestion/claviers/maj-clavier-caisse-balance",
        description : "Personnaliser le clavier caisse/balance via cette interface.",
    ...
    },
    {
        ...
        link : "/docs/manuel-gestion/claviers/maj-clavier-libre",
        description : "Modifier les produits du clavier « Produits Divers » que vous avez en caisse (selon paramétrage).",
    ...
    },
    {
        ...
        link : "/docs/manuel-gestion/claviers/maj-clavier-sans-cab",
        description : "Modifier les produits du clavier « Produits sans CAB » que vous avez en caisse (selon paramétrage).",
    ...
    },
    {
        ...
        link : "/docs/manuel-gestion/clients/releve-clients",
        description : "Imprimer un relevé des ventes pour un client sélectionné sur une période définie.",
    ...
    },
    {
        ...
        link : "/docs/manuel-gestion/commandes/commandes-centrales",
        description : "Envoyer au siège une demande d’approvisionnement de marchandise.",
    ...
    },
    {
        ...
        link : "/docs/manuel-gestion/commandes/commandes-clients",
        description : "Gérer vos commandes client depuis la gestion",
    ...
    },
    {
        ...
        link : "/docs/manuel-gestion/commandes/maj-retrait-commandes",
        description : "Modifier la liste des modes de retrait des commandes.",
        theme : "mise a jour Mise à Jour commande retrait "
    },
    {
        title : "Mise à jour des types de commandes",
        link : "/docs/manuel-gestion/commandes/maj-types-commandes",
        description : "Modifier la liste des types de commandes.",
        theme : "mise à jour types de commandes mise a jour des types de commandesmise a jour types de commande Mise à Jour des types de commandes Mise à jour types de commandes MISE A JOUR TYPES DE COMMANDES MISE A JOUR DES TYPES types de commande type commande "
    },    
    {
        title : "Mise à jour des unités de commandes",
        link : "/docs/manuel-gestion/commandes/maj-unites-commandes",
        description : "Renseigner des unités de commande, que vous pourrez choisir lors de la saisie d’une commande. ",
    ...
    },
    {
        ...
        link : "/docs/manuel-gestion/gestion-fournisseurs/achat-fournisseur",
        description : "Saisir, éditer et envoyer vos commandes fournisseurs.",
    ...
    },
    {
        ...
        link : "/docs/manuel-gestion/gestion-stocks/ajustement-stocks",
        description : "Saisir des mouvements de stock autres que des ventes, des réceptions ou des transferts de stock.",
    ...
    },
    {
        ...
        link : "/docs/manuel-gestion/gestion-stocks/transfert-stocks",
        description : "Créer le transfert des produits vers ou depuis un autre magasin.",
        theme : "Transfert des stocks transferts stocks Transférer des stocks TRANSFERT DE STOCKS TRANSFERT DES STOCKS TRANSFERT STOCKS"
    },
    {
        title : "Inventaire des stocks",
        link : "/docs/manuel-gestion/gestion-stocks/inventaire-stocks",
        description : "Effectuer vos inventaires partiels ou en totalité.",
    ...
    },
    {
        ...
        link : "/docs/manuel-gestion/prix-promotions/actions-commerciales",
    ...
    },
    {
        ...
        link : "/docs/manuel-gestion/prix-promotions/controle-prix",
        description : "Réaliser un audit de prix, c’est-à-dire d’imprimer un listing de produits avec leur prix afin d’éventuellement les comparer avec ceux de la concurrence.",
        theme : "controle des prix contrôle des prix CONTROLE DES PRIX Controle des prix Pour créer un nouvel audit, appuyer sur NOUVEAU. Cette page s’ouvre alors : Vous pouvez nommer et dater le contrôle de prix. 	Editer des étiquettes pour les produits choisis "
    },
    {
        title : "Mise à jour des motifs de remise",
        link : "/docs/manuel-gestion/prix-promotions/mise-a-jour-motifs-remise",
        description : "Gérer les motifs de remise.",
    ...
    },
    {
        ...
        link : "/docs/manuel-gestion/prix-promotions/suivi-coupons",
        description : "Afficher la liste des coupons. Par défaut, c’est la liste des coupons actifs qui s’affiche, c’est-à-dire les coupons qui n’ont pas encore été récupérés par la caisse.",
        theme : "suivi des coupons suivi coupons suivi coupon Suivi des coupons Suivi coupons SUIVI DES COUPONS SUIVI COUPON"
    },
    {
        title : "Contrôle des ventes",
        link : "/docs/manuel-gestion/ventes/controle-des-ventes",
        description : "Vérifier s'il n'y a pas d'écart dans les tickets.",
    ...
    },
    {
        ...
        link : "/docs/manuel-gestion/ventes/hit-parade-des-ventes",
        description : "Consulter toutes les statistiques nécessaires au bon suivi de votre point de vente.",
    ...
    },
    {
        ...
        link : "/docs/manuel-gestion/ventes/journal-des-ventes",
        ...
        theme : "journal des ventes JOURNAL DES VENTES Saisissez la date recherchée et lancez le traitement par la touche RECHERCHE. La partie basse de l’écran affiche le détail de la ligne du mouvement sur laquelle vous êtes positionné.  S’il s’agit d’une vente, vous pouvez consulter la fiche du produit sur lequel vous êtes positionné.  	S’il s’agit d’une action rattachée à un client, vous pouvez consulter la fiche du client concerné.  	S’il s’agit d’une action rattachée à un fournisseur, vous pouvez consulter la fiche du fournisseur concerné. 	Vous pouvez imprimer le journal en totalité. "
    },
    {
        title : "Ventes en compte",
        link : "/docs/manuel-gestion/ventes/ventes-en-compte",
        description : "Effectuer des ventes entre professionnels.",
        theme : "ventes en compte vente en compte Ventes en compte Vente en compte VENTE EN COMPTES VENTE COMPTE VENTE ENTRE PROFESSIONNELS ventes entre professionnel vente avec une entreprise vente avec entreprise VENTE AVEC UNE ENTREPRISE"
    },
    {
        title : "Analyse comparative",
        link : "/docs/manuel-gestion/analytique/analyse-comparative",
        description : "Suivre les courbes d'évolution de diverses données.",
        theme : "analyse comparative ANALYSE COMPARATIVE courbes evolution statistiques",
    },
    {
        title : "Suivi des objectifs",
        link : "/docs/manuel-gestion/analytique/suivi-des-objectifs",
        description : "Mettre en place des objectifs, tant en nombre de clients qu'en chiffre d'affaires",
        theme : "suivi des objectifs SUIVI DES OBJECETIFS SUIVI OBJECTIFS suivi objectifs"
    },
    {
        title : "Analyse géographique",
        link : "/docs/manuel-gestion/analytique/analyse-geographique",
        description : "Suivre l’analyse des départements et des villes de provenance de vos clients.",
        theme : "analyse géographique ANALYSE GEOGRAPHIQUE Analyse geographique analyse geographique code postal departement département"
    },
    {
        title : "Devis client",
        link : "/docs/manuel-gestion/clients/devis-client",
        description : "Créer des devis pour vos clients depuis la gestion.",
        theme : "devis client Devis Client Devis client DEVIS CLIENT"
    },
    {
        title : "Mise à jour des titres",
        link : "/docs/manuel-gestion/clients/maj-titres",
        description : "Modifier la liste des titres associés aux clients.",
        theme : "mise à jour des titres MISE A JOUR DES TITRES Mise à jour des titres mise a jour des titres mise a jour des titres"
    },
    {
        title : "Clôture magasin",
        link : "/docs/manuel-gestion/gestion-de-caisse/cloture-magasin",
        description : "Clôturer vos caisses à partir du Back Office ou ressortir une clôture d’une date antérieure.",
        theme : "cloture magasin CLOTURE MAGASIN Cloture magasin clôture magasin CLÔTURE MAGASIN Clôture magasin clôture du magasin cloturer clôturer Cloture du magasin Clôture du magains cloture du magasin CLOTURE DU MAGASIN"
    },
    {
        title : "Historique des états",
        link : "/docs/manuel-gestion/gestion-de-caisse/historique-etats",
        description : "L’historique des états conserve toutes les impressions qui ont été générées.",
        theme : "historique des etats historique des états historique états historique etats Historique des états Historique états Historique des etats Historique etats HISTORIQUE DES ETATS HISTORIQUE ETAT"
    }, 
    {
        title : "Liste des règlements",
        link : "/docs/manuel-gestion/gestion-de-caisse/liste-reglements",
        description : "Ressortir, pour une journée déterminée, la liste de tous les règlements.",
        theme : "liste des règlements liste des reglements liste reglements liste des reglements la liste des règlements la liste des reglements LA LISTE DES REGLEMENTS LISTE DES REGLEMENT LISTE REGLEMENTS"
    },
    {
    ...
    {
        title : "Mise à jour des dépenses",
        link : "/docs/manuel-gestion/gestion-de-caisse/maj-depenses",
        description : "Gérer les libellés de vos dépenses.",
        theme : "mise a jour depenses mise à jour des depenses mise à jour dépenses MISE A JOUR DEPENSES mise à jour de dépenses mise a jour des depenses Mise à jour Mise a jour"
    },
    {
        title : "Mise à jour des recettes",
        link : "/docs/manuel-gestion/gestion-de-caisse/maj-recettes",
        description : "Gérer les libellés de vos recettes.",
        theme : "mise a jour recettes mise à jour des recettes mise à jour dépenses MISE A JOUR RECETTES mise à jour de dépenses mise a jour des recettes Mise à jour Mise a jour"
    },
    {
        title : "Mise à jour des règlements",
        link : "/docs/manuel-gestion/gestion-de-caisse/maj-reglements",
        description : "Paramétrer vos moyens de règlement.",
        theme : "mise a jour reglements mise a jour des reglements mise à jour règlements mise à jour des règlements MISE A JOUR REGLEMENT MISE A JOUR DES REGLEMENTS Mise à jour Mise a jour"
    },
    {
        title : "Paniers des balances",
        link : "/docs/manuel-gestion/gestion-de-caisse/paniers-balances",
        description : "Retrouver la liste des paniers balances en attente.",
        theme : "Paniers en attente Vente en attente vente en attentepaniers en attente paniers balance en attente balance en attente paniers des balances mise en attente reprise attente REPRISE ATTENTE MISE EN ATTENTE PANIERS BALANCES EN ATTENTE PANIERS DES BALANCES"
    },
    {
        title : "Paniers en attente",
        link : "/docs/manuel-gestion/gestion-de-caisse/paniers-en-attente",
        description : "Retrouver la liste des paniers en attente.",
        theme : "paniers en attente Vente en attente vente en attente panier en attente mise en attente reprise attente PANIERS EN ATTENTE PANIER EN ATTENTE MISE EN ATTENTE REPRISE ATTENTE Paniers en attente"
    },
    {
        title : "Remise et suivi coffre",
        link : "/docs/manuel-gestion/gestion-de-caisse/remise-suivi-coffre",
        description : "Gérer le coffre, les mouvements d’argent au sein du magasin et les remises en banque.",
        theme : "REMISE ET SUIVI COFFRE remise et suivi coffre COFFRE suivi coffre Suivi coffre remise en banque remises en banques argent mouvement argent ARGENT MOUVEMENT ARGENT REMISES EN BANQUE REMISE"
    },
    {
        title : "Export comptabilité",
        link : "/docs/manuel-gestion/gestion-des-donnees/export-comptabilite",
        description : "Générer des fichiers d’exports comptables à destination de logiciels de comptabilité.",
        theme : "export comptabilite export comptabilité fichers d'export comptables logiciels de coomptabilité Export comptabilite EXPORT COMPTABLE EXPORT COMPTABILITE"
    },
    {
        title : "Mise à jour des options magasin",
        link : "/docs/manuel-gestion/gestion-des-donnees/MAJ-options-magasin",
        description : "Modifier les options du logiciel S2Cash.",
        theme : "mise a jour options magasin mise à jour options magasin mise a jour option mise à jour options MISE A JOUR OPTIONS MAGASIN MISE A JOUR OPTION MAGASIN Mise à jour options"
    },
    {
        title : "Etats de rétrocession",
        link : "/docs/manuel-gestion/gestion-fournisseurs/etats-retrocession",
        description : "Etablir et envoyer les états de rétrocession pour les fournisseurs.",
        theme : "états de rétrocession etats de retrocession ETATS DE RETROCESSION Etat de rétrocession Etats de retrocession"
    },
    {
        title : "Cadencier produit",
        link : "/docs/manuel-gestion/gestion-produits/cadencier-produit",
        description : "Consulter l'aide à l'achat, grâce à un condensé de l'historique des achats et des ventes.",
        theme : "aide a l'achat aide à l'achat Aide à l'achat Aide a l'achat cadencier produit achat et vente CANDENCIER PRODUIT AIDE A L'ACHAT AIDE ACHAT"
    },
    {
        title : "Edition des produits",
        link : "/docs/manuel-gestion/gestion-produits/edition-des-produits",
        description : "Editer et imprimer la liste de vos produits.",
        theme : "Edition des produits édition des produits edition des produits édition produits edition produit EDITION PRODUIT EDITION DES PRODUITS liste des produits imprimer liste produits IMPRIMER LISTE PRODUITS"
    },
    {
        title : "Mise à jour des familles",
        link : "/docs/manuel-gestion/gestion-produits/maj-familles",
        description : "Gérer la liste de vos familles.",
        theme : "mise a jour familles mise à jour des familles mise à jour familles MISE A JOUR FAMILLES mise a jour des familles Mise à jour familles Mise a jour familles"
    },
    {
        title : "Mise à jour des produits",
        link : "/docs/manuel-gestion/gestion-produits/maj-produits",
        description : "Gérer tout ce qui concerne vos produits.",
        theme : "mise a jour produits mise à jour des produits mise à jour produits MISE A JOUR PRODUITS mise a jour des produits Mise à jour produits Mise a jour produits"
    },
    {
        title : "Mise à jour des rayons balance",
        link : "/docs/manuel-gestion/gestion-produits/maj-rayons-balance",
        description : "Définir les familles de produit envoyées dans les différents rayons balance.",
        theme : "mise a jour rayon balance mise à jour rayon balance mise a jour rayons balance mise à jour des rayons balance mise à jour rayons balance MISE A JOUR RAYONS BALANCE mise a jour des rayons balance Mise à jour rayons balance Mise a jour rayons balance"
    },
    {
        title : "Mise à jour des rayons",
        link : "/docs/manuel-gestion/gestion-produits/maj-rayons",
        description : "Gérer la liste de vos rayons.",
    ...
    },
    {
        ...
        theme : "mise a jour tva mise à jour tva mise a jour tva mise à jour des tva mise à jour tva MISE A JOUR TVA mise a jour des tva Mise à jour tva Mise a jour tva"
    },
    {
        title : "Liste des mouvements",
        link : "/docs/manuel-gestion/gestion-stocks/liste-mouvements",
        description : "Suivre la totalité des mouvements effectués sur votre point de vente.",
        theme : "liste des mouvements liste mouvements Liste des mouvements Liste mouvements LISTE DES MOUVEMENTS LISTE MOUVEMENTS"
    },
    {
    ...
    {
        title : "Mise à jour des niveaux",
        link : "/docs/manuel-gestion/gestion-utilisateurs/maj-niveaux",
        description : "Gérer le niveaux de vos utilisateurs.",
        theme : "mise a jour des niveaux mise à jour des niveaux mise a jour des niveaux mise à jour des des niveaux mise à jour des niveaux MISE A JOUR DES NIVEAUX mise a jour niveaux Mise à jour niveaux Mise a jour niveaux"
    },
    {
        title : "Mise à jour des plannings",
        link : "/docs/manuel-gestion/gestion-utilisateurs/maj-plannings",
        description : "Gérer le planning de présence de vos salariés.",
        theme : "mise a jour des plannings mise à jour plannings mise à jour des plannings mise a jour des plannings mise à jour des des plannings mise à jour des plannings MISE A JOUR DES PLANNINGS mise a jour plannings Mise à jour plannings Mise a jour plannings"
    },
    {
        title : "Mise à jour des utilisateurs",
        link : "/docs/manuel-gestion/gestion-utilisateurs/maj-utilisateurs",
        description : "Gérer les utilisateurs du logiciel S2Cash.",
        theme : "mise a jour des utilisateurs mise à jour utilisateurs mise à jour des utilisateurs mise a jour des utilisateurs mise à jour des des utilisateurs mise à jour des utilisateurs MISE A JOUR DES UTILISATEURS mise a jour utilisateurs Mise à jour utilisateurs Mise a jour utilisateurs"
    },
    {
        title : "Mise à jour des vendeurs balance",
